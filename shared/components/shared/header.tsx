...
export const Header: React.FC<Props> = ({hasSearch = true, hasCart = true, className}) => {
    ...
    React.useEffect(() => {
        ...
        if (searchParams.has('paid')) {
            toastMessage = 'Order successfully paid! Information has been sent to the email.';
        }
